...
export function WelcomeModal(props: Props) {
  ...
  const handleContinue = async () => {
    ...
    if (packId) {
      ...
      try {
        await startContentPackInstall("eXoWin3x", packId, pack?.display_name);
      } catch (e) {
        ...
        <Dialog.Positioner class="ark-dialog-positioner">
          <Dialog.Content class="ark-dialog-content">
            ...
            <p class="welcome-credit">
              ExoWin Pocket is an unofficial launcher. Every game, config, and piece
