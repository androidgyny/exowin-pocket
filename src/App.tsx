                      ...
                      <section class="settings-section">
                        ...
                        <Toggle
                          ...
                          hint={isOffline()
                            ...
                            : "Uploads parts of the games you have to other users while Exodium runs. Keeps the collection alive - but distributing game files carries legal risk in some countries. When off, no game data is uploaded."}
                        />
